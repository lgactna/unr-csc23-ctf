"""
This script is from https://github.com/icemonster/symbolic_mersenne_cracker/blob/main/main.py,
which implements the method for solving the Mersenne Twister (as it's implemented in Python)
using Z3 expressions as described in https://www.schutzwerk.com/en/blog/attacking-a-rng/.

I use it since it's very easy to export the Untwister class and work from there.
"""
